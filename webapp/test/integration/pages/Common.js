sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskMoshkareva/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskMoshkareva.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskMoshkareva/localService/mockserver"], function (mockserver) {
